        ...
        productosConCantidad.forEach((product) => {
            ...
            content.innerHTML = `
                <div class="offer-product" id="${product.id}">
                    ...
                    <button class="offer-product-button" id="btnComprar${product.id}">Comprar</button>
                </div> 
            `;
            offerProduct.append(content);
        
            // Obtener el botón de compra por su id generado dinámicamente
            let comprar = document.getElementById('btnComprar' + product.id);
